...
def save_trajectory(file, savepath, seqname=None):
    ...
    with open(join(savepath, '{0}.pkl'.format(seqname)), 'wb') as f:
        pickle.dump(file, f)
        ...
        while True:
            ...
            if done:
                ...
                if n % 50 == 0:
                    ...
                    save_trajectory(all_trajectories, SAVE_PATH, 'backup_{}'.format(seq))
                if n % 50 == 0:
                    save_trajectory(all_trajectories, SAVE_PATH, 'newest_{}'.format(seq))
